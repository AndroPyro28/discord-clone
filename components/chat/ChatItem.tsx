...
const ChatItem: React.FC<ChatItemProps> = ({
  ...
  const isImage = fileTypeImg.includes(fileType as string) && fileUrl;
  const isVideo = fileTypeVideo.includes(fileType as string) && fileUrl;
            ...
            if (isVideo) {
              return (
                <a
                  href={"#"}
                  rel="noopener noreferrer"
                  className="relative aspect-square rounded-md mt-2 overflow-hidden border flex items-center bg-secondary h-[20em] w-[20em]"
                >
                  <video
                    src={fileUrl}
